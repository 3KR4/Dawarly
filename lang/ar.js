const ar = {
  ...
  ad: {
    ...
    errors: {
      ...
      adTitleMax: "عنوان الإعلان يجب ألا يزيد عن {limit} حرف",
      description: "وصف الإعلان مطلوب",
      descriptionMax: "وصف الإعلان يجب ألا يزيد عن {limit} حرف",
  ...
  confirm: {
    ...
    updatePendingTitle: "احذر",
    updatePendingMessage:
      "أي تعديل ستقوم به سيؤدي إلى رجوع إعلانك إلى انتظار موافقة الأدمن.",
  ...
  dashboard: {
    ...
    forms: {
      ...
      errors: {
        ...
        titleMax: "العنوان يجب ألا يزيد عن {limit} حرف",
        descriptionMax: "الوصف يجب ألا يزيد عن {limit} حرف",
  ...
  legal: {
    ...
    sections: [
        ...
        blocks: [
          {
            heading: "1. المقدمة",
            paragraphs: [
              "توضح دوارلي كيف نقوم بجمع واستخدام وحماية بياناتك الشخصية عند استخدام الموقع أو التطبيق.",
              "باستخدامك دوارلي فأنت توافق على سياسة الخصوصية هذه.",
            ],
          },
          {
            heading: "2. البيانات التي نجمعها",
            paragraphs: [
              "قد نجمع بيانات الحساب والتواصل والحجوزات وبيانات الجهاز والاستخدام والموقع عند تفعيل الوصول للموقع.",
            ],
          },
          {
            heading: "3. كيف نستخدم بياناتك",
            list: [
              "تخصيص تجربتك والتوصيات المناسبة لك.",
              "معالجة الحجوزات والمدفوعات والمعاملات.",
              "إرسال التحديثات والعروض والدعم.",
              "تحسين أداء المنصة وأمانها.",
            ],
          },
          {
            heading: "4. مشاركة البيانات وحمايتها",
            paragraphs: [
              "لا تبيع دوارلي بياناتك الشخصية ولا تؤجرها. نشارك بيانات محدودة فقط مع شركاء موثوقين أو مزودي خدمة أو عند وجود التزام قانوني.",
              "نستخدم وسائل حماية مثل التشفير وتقييد الوصول، لكن لا توجد وسيلة نقل بيانات عبر الإنترنت آمنة بنسبة 100%.",
            ],
          },
          {
            heading: "5. حقوقك",
            list: [
              ...
              "سحب الموافقة على الرسائل التسويقية.",
              "طلب تفاصيل عن البيانات المخزنة.",
            ],
          },
          {
            heading: "6. التواصل",
            paragraphs: ["privacy@Dawaarly.com", "www.Dawaarly.com"],
          },
        ],
      },
      {
        ...
        blocks: [
          {
            ...
            paragraphs: [
              "باستخدامك دوارلي فأنت توافق على استخدام المنصة بشكل قانوني والحفاظ على بيانات حسابك.",
            ],
          },
          {
            heading: "2. الخدمات",
            paragraphs: [
              "توفر دوارلي إعلانات عقارية وأدوات حجز ومزايا سوق إلكتروني بصفتها وسيطًا رقميًا.",
            ],
          },
          {
            heading: "3. المدفوعات والمحتوى",
            paragraphs: [
              "تتم المدفوعات عبر مزودي خدمة معتمدين. يتحمل المستخدمون والبائعون مسؤولية دقة البيانات والإعلانات التي يقدمونها.",
            ],
          },
          {
            heading: "4. المسؤولية والقانون",
            paragraphs: [
              "لا تتحمل دوارلي مسؤولية خدمات الأطراف الثالثة أو أخطاء البائعين أو الأمور الخارجة عن سيطرتها. تخضع هذه الشروط للقانون المصري.",
            ],
          },
      ...
      },
      {
        ...
        blocks: [
          {
            heading: "1. ملفات تعريف الارتباط",
            paragraphs: [
              "تساعدنا ملفات تعريف الارتباط في إبقائك مسجل الدخول وتذكر الإعدادات وتحليل الزيارات وتخصيص التوصيات.",
            ],
          },
          {
            heading: "2. إدارة الملفات",
            paragraphs: [
              "يمكنك تعطيل ملفات تعريف الارتباط من إعدادات المتصفح، لكن قد يؤثر ذلك على بعض مزايا المنصة.",
            ],
          },
        ],
      },
      {
        ...
        blocks: [
          {
            heading: "1. مسؤوليات البائع",
            list: [
              "تقديم بيانات نشاط صحيحة ومحدثة.",
              "تقديم الخدمات كما هو موضح.",
              "اتباع قوانين حماية المستهلك والضرائب المصرية.",
              "تجنب المحتوى غير القانوني أو المضلل.",
            ],
          },
          {
            heading: "2. مسؤوليات دوارلي",
            list: [
              "إظهار إعلانات الشركاء على المنصة.",
              "إدارة التواصل وتدفق المدفوعات داخل المنصة.",
              "توفير الظهور والتحليلات عند توفرها.",
            ],
          },
  ...
  footer: {
    ...
    companyDesc:
      "دوارلي هو سوقك الموثوق لبيع وشراء المنتجات عبر الإنترنت في مصر.",
    address: "القاهرة، مصر",
