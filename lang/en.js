...
const en = {
  ...
  ad: {
    ...
    images: {
      ...
      helperTextSingle:
        "Drag and drop the image here or click to upload – single image only",
      clickHere: "Click here",
      dropHere: "Drop here",
      single: "Single image",
      max: "Maximum",
      limitReached: "Maximum number of images reached",
      disabledLabel: "Ad images",
      errors: {
        required: "Image is required",
        maxLimit: "You can upload up to {limit} images only",
      },
    },
